...
// before allowing a route change to complete
    ...
    //TODO: You can add your routes here. Added by Hamed...
    .config(['securityAuthorization', function (securityAuthorization){
        $routeProvider.when('admin/users', {
            resolve: securityAuthorization.requireAdminUser
        });
    }]);